      ...
      return [
        {
          ...
          params: {
            ...
            low_mid_q: 1.2,
            low_mid_type: "Bell",
              // Designed as a clearly subtractive vocal curve,
              // similar in spirit to the Trap Dancehall DSP
              // preset: tighten low end, remove mud, and cut a
              // narrow harsh band before compression.
              low_freq: 140,
              low_gain: -3.0,
              low_q: 0.8,
              low_type: "Shelf",
